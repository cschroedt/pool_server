...
smtp.write("Subject: Poolserver-Parameter\n\n")
smtp.write("Aussentemperatur: "+str(ATempKoeff0)+" "+str(ATempKoeff1)+" "+str(ATempOffset))
smtp.write("\nFilter: "+str(PFfrei)+" "+str(PFsaett))
smtp.write("\nLaufzeiten: "+str(pStart)+" "+str(pDauer))
smtp.send()
smtp.quit()

print("Poolparameter gesendet")
